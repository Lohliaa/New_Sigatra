         ...
         <div class="card mb-4 shadow-sm">
             <div class="card-header d-flex justify-content-between align-items-center">
                 ...
                 <div>
                     ...
                     <strong>Data Guru Pegawai Yayasan Permata Mojokerto</strong>
                 </div>
                 ...
                 <div class="d-flex align-items-center gap-2 mt-2">
                     ...
                     <!-- Button Tambah -->
                     <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambahDataPegawai">
                         <i class="bi bi-plus-circle"></i>
                     </button>

                     <!-- Modal Button Tambah -->
                     <div class="modal fade" id="modalTambahDataPegawai" tabindex="-1" aria-labelledby="modalTambahDataPegawai" aria-hidden="true">
                             ...
                             <div class="modal-content">
                                 <form action="{{ route('users.store') }}" method="POST">
                                     ...
                                     <div class="modal-header">
                                         <h5 class="modal-title" id="modalTambahDataPegawai">
                                             Tambah Data Pegawai
                                         </h5>
                     ...
                     <table id="datatablesSimple" class="table table-bordered table-striped align-middle">
                         ...
                         <tbody>
                             ...
                             <tr id="tr_{{ $h->id }}">
                                 ...
                                 <td>
                                     <div class="d-flex">
                                         <form id="deleteForm_{{ $h->id }}" action="{{ route('users.destroy', $h->id) }}"
                                             method="POST">
                                             @csrf
                                             @method('DELETE')
                                         ...
                                         <div class="modal fade" id="modalEdit{{ $h->id }}" tabindex="-1" aria-labelledby="modalEditLabel{{ $h->id }}" aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content">
                                                     ...
                                                     <form action="{{ route('users.update', $h->id) }}" method="POST">
                                                         @csrf
                                                         @method('PUT')
