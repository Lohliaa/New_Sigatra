...
<body>
    <div class="card shadow mb-4">
        <div class="card-header py-3 text-center">
            <h4 class="font-weight-bold mb-0">EDIT DATA SK GURU PEGAWAI SIT PERMATA</h4>
        </div>
            ...
            <form action="{{ route('sk.update', $sk->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        <label>NIPY</label>
                        <textarea name="nipy" class="form-control">{{ $sk->nipy }}</textarea>
                    </div>
                   ...
                   <div class="col-md-6 mt-3">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input type="text" name="berlaku" class="form-control" value="{{ $sk->berlaku }}">
                    </div>
                     <div class="col-md-6 mt-3">
                        <label>Tanggal Akhir</label>
                        <input type="date" name="tanggal_akhir" class="form-control" value="{{ $sk->tanggal_akhir }}">
                    </div>
                     <div class="col-md-6 mt-3">
                        <label>Tanggal Ditetapkan</label>
                        <input type="date" name="tanggal_ditetapkan" class="form-control" value="{{ $sk->tanggal_ditetapkan }}">
                    </div>
